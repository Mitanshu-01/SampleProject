    ...
    if(!_b.college_id || !_b.password) {
        ...
        try {
            ...
            if(!user) {
                ...
                const validPassword = user.password==_b.password
                ...
                if (validPassword) {
                    ...
                    res.status(200).json({ success: true, message: `OTP for verification has been sent to your registered college email. --${user.login_otp}`})
...
exports.login = async (req, res) => {
    ...
    if(!_b.college_id || !_b.password) {
        ...
        try {
            ...
            let validPassword = _b.password==user.password;
